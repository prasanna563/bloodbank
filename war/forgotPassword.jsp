...
function func(){
	...
	alert("Your Password has been mailed to your e-Mail");
}
</script>
</head>
<body>
	...
	<div class="container" id="d1">
		<div class="page-header">
			<h1 style="text-align: center">
				<span class="glyphicon glyphicon-pencil"> ForgotPassword</span>
			</h1>
		</div>
		<form method="post" action="forgotpassword" role="form" name="form1"">
			...
			<button type="submit" onclick="func()" class="btn btn-default">
	...
	<div class="learn-more" style="padding-top: 120px">
